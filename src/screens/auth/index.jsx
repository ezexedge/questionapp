  ...
  return (
    <KeyboardAvoidingView
      ...
      <View style={styles.container}>
        <View style={{ ...styles.content, minHeight: !isLogin ? 500 : 330 }}>
          ...
          {!isLogin && (
            <>
              <Input
                ...
                autoCapitalize="none"
                autoCorrect={false}
                onChangeText={(text) => onHandlerInputChange(text, 'firstName')}
              ...
              <Input
                ...
                autoCapitalize="none"
                autoCorrect={false}
                onChangeText={(text) => onHandlerInputChange(text, 'lastName')}
